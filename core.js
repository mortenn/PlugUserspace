(function(){
	window.freshy.currentVersion('freshy', 64, API.ROLE.NONE);
	...
	window.freshy.currentVersion('senpai', 212, API.ROLE.NONE);
	...
	window.freshy.currentVersion('multipass', 132, API.ROLE.NONE);
	...
	window.freshy.currentVersion('kouhai', 154, API.ROLE.BOUNCER);
})();
