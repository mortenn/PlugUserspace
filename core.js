(function(){
	...
	window.freshy.currentVersion('senpai', 218, API.ROLE.NONE);
	...
	window.freshy.currentVersion('multipass', 169, API.ROLE.NONE);
	...
	window.freshy.currentVersion('kouhai', 156, API.ROLE.BOUNCER);
})();
