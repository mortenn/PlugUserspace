(function(){
	window.freshy.currentVersion('freshy', 62, API.ROLE.NONE);
	window.freshy.currentVersion('soundbank', 97, API.ROLE.NONE);
	window.freshy.currentVersion('chatalert', 34, API.ROLE.NONE);
	...
	window.freshy.currentVersion('senpai', 210, API.ROLE.NONE);
