(function(){
	...
	var multipass = {
		...
		manageOrganizeButton: function()
		{
			...
			button = $('<div id="playlist-organize-button" class="button" style="right:550px;"><span title="'+tooltip+'">'+_('Organize')+'</span></div>');
		...
		manageCheckAllButton: function()
		{
			...
			button = $('<div id="playlist-checkall-button" class="button" style="right:450px;"><span title="'+tooltip+'">'+_('Check all').replace(' ','&nbsp;')+'</span></div>');
			$('#playlist-edit-button').before(button);
			button.click(
				function()
				{
